...
public class RobotMap {
    ...
    public static WPI_TalonSRX diveTrainLeftFrontMotor;
    public static WPI_TalonSRX diveTrainLeftRearMotor;
    public static WPI_TalonSRX diveTrainRightFrontMotor;
    public static WPI_TalonSRX diveTrainRightRearMotor;
    public static AnalogGyro diveTrainDoNotUse;
    ...
    public static void init() {
        ...
        diveTrainLeftFrontMotor = new WPI_TalonSRX(11);
        
        
        diveTrainLeftRearMotor = new WPI_TalonSRX(10);
        
        
        diveTrainRightFrontMotor = new WPI_TalonSRX(2);
        
        
        diveTrainRightRearMotor = new WPI_TalonSRX(3);
        
        
        diveTrainDoNotUse = new AnalogGyro(0);
        LiveWindow.addSensor("DiveTrain", "DoNotUse", diveTrainDoNotUse);
        diveTrainDoNotUse.setSensitivity(0.007);
